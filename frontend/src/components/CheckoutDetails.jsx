...
//   const handleSubmitBillingDetails = (e) => {
//     e.preventDefault();
...
//     // Submit billing details (e.g., send to backend API)
//     console.log('Billing Details Submitted:', billingDetails);
//     // You can add the logic to submit this data to your backend API here
//   };
...
//     <p><strong>Total:</strong> {checkoutDetails.subtotal} tk</p>
//     <p><strong>Delivery Charge:</strong> {checkoutDetails.deliveryCharge} tk</p>
//     <p><strong>Sub Total Price:</strong> {checkoutDetails.totalPrice} tk</p>
//     <p><strong>Checkout Date:</strong> {new Date(checkoutDetails.checkoutDate).toLocaleString()}</p>
//   </div>
...
//           method: 'GET',
//           headers: {
//             Authorization: `Bearer ${localStorage.getItem('token')}`, // Fixed Template Literals
//           },
//         });
//         const data = await response.json();
...
//     const payload = {
//       userId: user.id, // Assuming user.id is the logged-in user's ID
