...
//       options: ["Oud", "Floral", "Amber", "Fresh", "Woody"],
//     },
//     {
//       id: "brand",
//       question: "Do you have a preferred brand?",
//       options: [...new Set(Data.map((item) => item.brand))], // Unique brands from Data
//     },
//   ];
...
//   const findPerfume = () => {
//     const { outfit, price, fragrance, brand } = answers;

//     // Filter perfumes based on user's answers
...
//           : perfume.price > 3500;
//       const matchesFragrance = fragrance
//         ? perfume.name.toLowerCase().includes(fragrance.toLowerCase()) ||
//           perfume.description.toLowerCase().includes(fragrance.toLowerCase())
//         : true;
//       const matchesBrand = brand ? perfume.brand === brand : true;

//       return matchesOutfit && matchesPrice && matchesFragrance && matchesBrand;
//     });

//     // Select a random perfume if multiple match
//     const selectedPerfume =
//       filteredPerfumes[Math.floor(Math.random() * filteredPerfumes.length)];
//     setResult(selectedPerfume || "No matching perfume found.");
//   };
